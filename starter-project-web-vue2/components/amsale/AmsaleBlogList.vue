<template>
  ...
  <v-card
    class="mx-auto elevation-20 mt-5"
        ...
        <v-card-title>
          <div>
            <div class="text-h5">
              ...
              <p class="text-sm">
                Ellie Goulding   Halycon Days he People write alot about movies even more than People write alot about movies even more than
              </p>
