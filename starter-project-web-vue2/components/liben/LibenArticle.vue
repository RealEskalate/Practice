  ...
  >
    ...
    <v-card-text>
      <v-row align="center" class="mx-0">
        <v-rating
          :value="calculateRating(blog.rating)"
          color="amber"
          dense
          half-increments
          readonly
    ...
    <v-card-text>
      <v-chip-group
        ...
        column
        v-if="blog.categories != null || blog.categories != undefined"
      >
        <v-chip v-for="(cat, index) in blog.categories" :key="index">{{
          cat
        }}</v-chip>
      </v-chip-group>
